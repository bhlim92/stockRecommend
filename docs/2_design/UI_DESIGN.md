...
| **v1.2** | 2026-06-07 | - 실시간 보유 현황에 개인연금 통합 표시를 위한 12컬럼 테이블 레이아웃 설계<br>- HSL 테마 기반 계좌 구분 뱃지(.badge-stock: Cyan, .badge-pension: Amber) 설계 및 적용 | `Antigravity` | `Antigravity (팀장)` |
...
- **디자인 스타일시트:** [style.css](file:///c:/Users/samsung/proj/stockRecommend/app/static/style.css)
- **웹 대시보드 마크업:** [index.html](file:///c:/Users/samsung/proj/stockRecommend/app/static/index.html)
- **프론트엔드 연동 스크립트:** [app.js](file:///c:/Users/samsung/proj/stockRecommend/app/static/app.js)
